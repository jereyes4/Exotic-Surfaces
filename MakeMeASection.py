...
# This is a command-line program with a graphical output.
# It takes indices from a .jsonl file and exports those
# to latex in a compact way. Used in the article at the
# end of each section.
